  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to ParamiYonet, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Devosuit - ParamiYonet.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Devosuit - ParamiYonet, accessible
            from{' '}
            <a
              href="https://devosuit.com/paramiyonet"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://devosuit.com/paramiyonet
            </a>
          </p>
        </li>
        <li>
